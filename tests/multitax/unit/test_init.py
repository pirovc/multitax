...
class TestInit(unittest.TestCase):
    ...
    def test_root_values(self):
        ...
        tax = MultiTax(root_node="root_n", root_parent="root_p",
                       root_name="newRootName", root_rank="newRootRank")
        ...
        self.assertEqual(tax._nodes, {
                         tax.root_node: tax.root_parent, tax._default_root_node: tax.root_node})
        ...
        tax = CustomTx(files=self.test_file, root_node="root_n",
                       root_parent="root_p", root_name="newRootName", root_rank="newRootRank")
        self.assertEqual(tax.root_node, "root_n")
        self.assertEqual(tax.root_parent, "root_p")
        ...
        tax = CustomTx(files=self.test_file, root_node="4.4", root_parent="root_p",
                       root_name="newRootName", root_rank="newRootRank")
        ...
        self.assertEqual(tax.parent(tax._default_root_node),
                         tax.undefined_node)
    ...
    def test_undefined_values(self):
        ...
        """
        tax = MultiTax(undefined_node="unode",
                       undefined_rank="urank", undefined_name="uname")
        ...
        tax = CustomTx(files=self.test_file, undefined_node="unode",
                       undefined_rank="urank", undefined_name="uname")
        self.assertEqual(tax.undefined_node, "unode")
        self.assertEqual(tax.undefined_name, "uname")
        self.assertEqual(tax.undefined_rank, "urank")
    ...
    def test_build_values(self):
        ...
        test init changing undefined values
        """
        tax = MultiTax(build_node_children=True,
                       build_name_nodes=True, build_rank_nodes=True)
        self.assertEqual(tax._name_nodes, {
                         tax.name(tax.root_node): [tax.root_node]})
        self.assertEqual(tax._node_children, {
                         tax.root_parent: [tax.root_node]})
        self.assertEqual(tax._rank_nodes, {"root": [tax.root_node]})

        tax = CustomTx(files=self.test_file, build_node_children=True,
                       build_name_nodes=True, build_rank_nodes=True)
